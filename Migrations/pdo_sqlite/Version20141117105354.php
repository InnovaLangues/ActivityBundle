...
class Version20141117105354 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        ");
        $this->addSql("
            DROP INDEX IDX_4605013F28CE5809
        ");
        $this->addSql("
        ...
        $this->addSql("
            CREATE TABLE innova_activity (
                ...
                updatedDate DATETIME NOT NULL, 
                PRIMARY KEY(id), 
                CONSTRAINT FK_4605013F28CE5809 FOREIGN KEY (activitySequence_id) 
                REFERENCES innova_activitySequence (id) 
                ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE, 
                CONSTRAINT FK_4605013FF675F31B FOREIGN KEY (author_id) 
        ...
        ");
        $this->addSql("
            CREATE TEMPORARY TABLE __temp__innova_activitySequence AS 
            SELECT id, 
            description 
            FROM innova_activitySequence
        ");
        $this->addSql("
        ...
        ");
        $this->addSql("
            INSERT INTO innova_activitySequence (id, description) 
            SELECT id, 
            description 
            FROM __temp__innova_activitySequence
        ");
        $this->addSql("
            DROP TABLE __temp__innova_activitySequence
        ");
    }
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql("
            CREATE TABLE innova_activitySequence (
                ...
                PRIMARY KEY(id), 
                CONSTRAINT FK_D614C342B87FAB32 FOREIGN KEY (resourceNode_id) 
